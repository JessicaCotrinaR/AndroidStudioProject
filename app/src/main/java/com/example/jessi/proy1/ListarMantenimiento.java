...
public class ListarMantenimiento extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_mantenimiento);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_listar_mantenimiento, menu);
        return true;
    }
    ...
    private void  ListadoMantenimientos() {
        Thread th = new Thread(){
            @Override
            public void run(){
                String NameSpace = "http://tempuri.org/";
                String URL = "http://192.95.38.126/WSProy/WebSMantenimiento.asmx";
                String MethodName = "ListarMantenimiento";
                String SoapAction = "http://tempuri.org/ListarMantenimiento";
                ...
                runOnUiThread(new Runnable(){
                    public void run(){
                        lsvLista = (ListView)findViewById(R.id.lsvMantenimiento);
                        ArrayAdapter<String> adaptador = new ArrayAdapter<String>(
                                ListarMantenimiento.this,
