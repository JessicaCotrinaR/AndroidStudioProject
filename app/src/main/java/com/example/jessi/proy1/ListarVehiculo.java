...
public class ListarVehiculo extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_vehiculo);
        ListadoVehiculos();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_listar_vehiculo, menu);
        return true;
    }
    ...
    private void ListadoVehiculos() {
        Thread th = new Thread(){
            ...
            public void run(){
                ...
                String MethodName = "ListarVehiculo";
                String SoapAction = "http://tempuri.org/ListarVehiculo";
                ...
                runOnUiThread(new Runnable(){
                    public void run(){
                        lsvLista = (ListView)findViewById(R.id.lsvVehiculo);
